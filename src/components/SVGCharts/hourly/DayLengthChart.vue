...
export default {
  ...
  computed: {
    ...
    /**
     * Условия отображения текста с длительностью дня или признака
     * полярный день/ночь:
     * - указана длительность дня и время восхода и
     * - расстояние от левого края элемента до иконки восход больше
     * 75 и
     * - расстояние между иконками восход и закат больше 90
     * - или есть признак полярный день/ночь.
     */
    isShowDayLength() {
      return (
    ...
    /**
     * Условия отображения пунктирной линии:
     * - есть признак полярный день
     * - или есть время восхода
     * - или есть время заката.
     */
    isShowLine() {
      return (
  ...
  methods: {
     ...
     * ее.
     * @param point Строка может принимать два допустимых значения:
     * - sunrise
     * - sunset
     */
    calcX(point) {
    ...
    /**
     * Определяет и устанавливает требуемые для отрисовки элементов svg
     * параметры.
     */
    size() {
      /**
